#kubectl exec -it spark -- /bin/bash
#kubectl exec --namespace=spark-and-postgres -it spark -- /bin/bash
kubectl exec --namespace=spark-and-postgres -it spark -- ./bin/spark-submit \
